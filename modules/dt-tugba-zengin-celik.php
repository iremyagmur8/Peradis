      ...
      <div class="container">
        <div class="row">
          <div class="col-12 d-flex flex-wrap justify-content-end align-items-center">
            <a href="<?=translator('appointment','path')?>" class="btn btn__white btn__rounded"><?=translator('Online Appointment','dt-tugba-zengin-celik')?></a>
          </div><!-- /.col-12 -->
        </div><!-- /.row -->
      </div><!-- /.container -->
    </section><!-- /.page-title -->
        ...
        <div class="row">
            ...
            <aside class="sidebar has-marign-right">
              <div class="widget widget-member shifted-top">
                <div class="member mb-0">
                  ...
                  <div class="member__info">
                    <h5 class="member__name"><a href="#"> <?=translator('Specialist  Dt.Tugba Zengin Celik','dt-tugba-zengin-celik')?> </a></h5>
              ...
              <div class="widget widget-help bg-overlay bg-overlay-primary-gradient">
                ...
                <div class="widget-content">
                  ...
                  <h4 class="widget__title"><?=translator('Emergencies','dt-tugba-zengin-celik')?></h4>
                  <p class="widget__desc"><?=translator('Please feel free to contact our friendly reception staff with any general or medical inquiry,call us.','dt-tugba-zengin-celik')?>
              ...
              <div class="widget widget-schedule">
                <div class="widget-content">
                  ...
                  <h4 class="widget__title"><?=translator('Working Hours','dt-tugba-zengin-celik')?></h4>
                  <ul class="time__list list-unstyled mb-0">
                  <li><span><?=translator('Monday-Saturday','dt-tugba-zengin-celik')?></span><span>10:00 - 20:00</span></li>
                  </ul>
                </div><!-- /.widget-content -->
              </div><!-- /.widget-schedule -->
            </aside><!-- /.sidebar -->
          ...
          <div class="col-sm-12 col-md-12 col-lg-8">
            <div class="text-block mb-50">
              <h5 class="text-block__title"><?=translator('Education','dt-tugba-zengin-celik')?></h5>
            ...
            <li>
                <h5 class="details__title"><?=translator('Profession','dt-tugba-zengin-celik')?></h5>
                <div class="details__content">
                  <p class="mb-0"><?=translator('Specialist in Periodontics','dt-tugba-zengin-celik')?></p>
                </div>
              </li>
            <li>
                <h5 class="details__title"><?=translator('University','dt-tugba-zengin-celik')?></h5>
                <div class="details__content">
                  <p class="mb-0"><?=translator('Istanbul University Department of Periodontology','dt-tugba-zengin-celik')?>2010</p>
                </div>
              </li>
              <li>
                <h5 class="details__title"><?=translator('Specialist','dt-tugba-zengin-celik')?></h5>
                <div class="details__content">
                  <p class="mb-0"><?=translator('Bezmialem Vakif University Department of Periodontology','dt-tugba-zengin-celik')?>&nbsp;&nbsp;2018</p>
                </div>
              </li>
              
              <!-- <li>
                <h5 class="details__title">Uzmanlık Alanları</h5>
                <div class="details__content">
              ...
              <!-- <li>
                <h5 class="details__title">Ofis</h5>
                <div class="details__content">
            ...
            <section class="contact-layout4 bg-overlay bg-overlay-secondary-gradient pb-50 pb-50">
              ...
              <form class="contact-panel__form" method="post" action="send_mail" enctype="multipart/form-data">
                <div class="row">
                  <div class="col-sm-12">
                    <h4 class="contact-panel__title"><?=translator('Online Appointment','dt-tugba-zengin-celik')?></h4>
                    <p class="contact-panel__desc mb-30"><?=translator('If you have any quesitons or if you need help, do not hesitate to contact our team.','dt-tugba-zengin-celik')?>
                  </div>
